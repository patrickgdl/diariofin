    ...
    <section className="flex justify-between space-y-12 md:space-y-0 md:space-x-8 flex-col md:flex-row overflow-hidden mb-12">
      ...
      >
        ...
        <p className="text-[#878787]">
          Elimine o incômodo de preparar exportações. Apenas selecione qualquer
          período de tempo ou transação desejada e clique em exportar. Nós
          empacotamos tudo ordenadamente.
        </p>
        <motion.div
      ...
      >
        <div className="flex flex-col md:flex-row md:space-x-12">
          ...
          <div className="mt-6 md:max-w-[40%] md:ml-8">
            ...
            <p className="text-[#878787]">
              Com a IA da Diariofin, você pode perguntar qualquer coisa e obter
              insights sobre o seu situação financeira. Entenda suas principais
              despesas e receitas fontes. Informe-se sobre transações sem
              recibos ou explore padrões de receita como taxa de consumo ou MRR.
